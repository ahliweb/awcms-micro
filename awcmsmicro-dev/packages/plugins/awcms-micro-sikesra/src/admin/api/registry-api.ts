...
export function listRegistryArchive<TResponse>(payload: SikesraRegistryListRequest, options: RequestOptions<SikesraRegistryListRequest>) {
	return postSikesraPlugin<TResponse, SikesraRegistryListRequest>({ ...options, path: "registry/archive/list", payload });
}

export function softDeleteRegistry<TResponse>(payload: SikesraSoftDeleteRequest, options: RequestOptions<SikesraSoftDeleteRequest>) {
	return postSikesraPlugin<TResponse, SikesraSoftDeleteRequest>({ ...options, path: "registry/soft-delete", payload });
}

export function restoreRegistry<TResponse>(payload: SikesraRestoreRequest, options: RequestOptions<SikesraRestoreRequest>) {
	return postSikesraPlugin<TResponse, SikesraRestoreRequest>({ ...options, path: "registry/restore", payload });
}
