import type { SikesraImportCreateRequest, SikesraImportPromotionRequest } from "../../contracts/index.js";
...
export function createImportBatch<TResponse>(payload: SikesraImportCreateRequest, options: RequestOptions<SikesraImportCreateRequest>) {
	return postSikesraPlugin<TResponse, SikesraImportCreateRequest>({ ...options, path: "import/create", payload });
}
