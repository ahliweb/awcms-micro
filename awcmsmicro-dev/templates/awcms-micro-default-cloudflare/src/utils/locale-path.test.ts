...
describe("locale path helpers", () => {
	it("adds a locale prefix only for non-default locales", () => {
	...
	it("removes an existing locale prefix before rebuilding the target path", () => {
	...
	it("leaves admin and asset paths untouched", () => {
	...
	it("uses content slug when available", () => {
