const PUBLIC_COPY = {
	en: {
		...
		// Footer
		footerBrandDesc: "Resilient web templates and plugins built on top of EmDash. Lightweight, fast, and Cloudflare-ready.",
	...
	id: {
		...
		// Footer
		footerBrandDesc: "Template web dan plugin tangguh yang dibangun di atas EmDash. Ringan, cepat, dan siap Cloudflare.",
		footerLinksProduct: "Produk",
		footerLinksResources: "Sumber Daya",
		footerLinksCompany: "Perusahaan",
		footerLinkFeatures: "Fitur",
		footerLinkGallery: "Galeri",
