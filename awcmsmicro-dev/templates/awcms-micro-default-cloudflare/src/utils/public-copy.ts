const PUBLIC_COPY = {
	en: {
		...
		pluginEnabledDescription: "Registers `@awcms-micro/plugin-example` through the normal EmDash plugin path for audit, access-rights, and ABAC examples.",
	...
	id: {
		...
		pluginEnabledDescription: "Mendaftarkan `@awcms-micro/plugin-example` melalui jalur plugin EmDash normal untuk contoh audit, hak akses, dan ABAC.",
