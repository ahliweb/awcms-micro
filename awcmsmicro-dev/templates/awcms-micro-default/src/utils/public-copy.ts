const PUBLIC_COPY = {
	en: {
		...
		galleryListIntro: "Browse our curated collections of photos and videos from events, activities, and highlights.",
		...
		featuredGalleryDescription: "View our featured gallery collection managed from the admin panel.",
	...
	id: {
		...
		galleryListIntro: "Telusuri koleksi foto dan video pilihan dari berbagai acara, kegiatan, dan momen penting kami.",
		...
		featuredGalleryDescription: "Lihat koleksi galeri unggulan kami yang dikelola dari panel admin.",
