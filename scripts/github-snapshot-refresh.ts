 ...
 * docs at `docs/awcms-micro/github/` from live repository state, so a
 ...
 * (defaults to ahliweb/awcms-micro if omitted)
 *
...
async function main() {
  const repo = process.argv[2] ?? "ahliweb/awcms-micro";
