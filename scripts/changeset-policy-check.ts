 ...
 * changeset (e.g. PR #595, #585 — pure `docs/awcms-micro/github/**`
...
export function evaluateChangesetPolicy(
  ...
  return {
    ...
    violation:
      ...
      `perubahan — lihat docs/awcms-micro/09_roadmap_repository_commit.md §Versioning ` +
...
const CHANGESET_PACKAGE_NAME = "awcms-micro";
