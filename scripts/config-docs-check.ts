 ...
 * `docs/awcms-micro/18_configuration_env_reference.md` were maintained by
 ...
 * but absent from the real `.env.example`, `AWCMS_MICRO_APP_DB_PASSWORD`
...
export const DOC_18_PATH = "docs/awcms-micro/18_configuration_env_reference.md";
