 ...
 * contracts — `openapi/awcms-micro-public-api.openapi.yaml` (produced by
 * `bun run openapi:bundle`, Issue #695) and
 * `asyncapi/awcms-micro-domain-events.asyncapi.yaml`. This script never
...
export const API_REFERENCE_PATH = "docs/awcms-micro/api-reference.md";
...
function renderHeader(openApi: AnyRecord, asyncApi: AnyRecord): string {
  ...
  return `# AWCMS-Micro API & Event Reference (generated)
...
> (\`openapi/awcms-micro-public-api.src.yaml\` + \`openapi/modules/*.yaml\`) or
...
\`tenantHeader\` (\`X-AWCMS-Micro-Tenant-ID\`) carries the active tenant for
...
\`X-AWCMS-Micro-Node-ID\`, \`X-AWCMS-Micro-Timestamp\`, \`X-AWCMS-Micro-Signature\`.
