...
export const DYNAMIC_KEY_FAMILIES: readonly DynamicKeyFamily[] = [
  ...
  },
  {
    ...
    source:
      "sql/031_awcms_micro_tenant_domain_schema.sql CHECK (status IN ('pending_verification','active','suspended','failed')); src/modules/tenant-domain/domain/tenant-domain-validation.ts TENANT_DOMAIN_UPDATABLE_STATUSES covers all but 'active'"
  },
  {
...
const POT_HEADER = [
  'msgid ""',
  'msgstr ""',
  '"Project-Id-Version: awcms-micro\\n"',
