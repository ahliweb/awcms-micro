 ...
 * a root fragment (`openapi/awcms-micro-public-api.src.yaml`) holding the
 ...
 * already uses, `openapi/awcms-micro-public-api.openapi.yaml` -- that file
...
export const ROOT_SRC_PATH = "openapi/awcms-micro-public-api.src.yaml";
export const MODULES_DIR = "openapi/modules";
export const BUNDLED_PATH = "openapi/awcms-micro-public-api.openapi.yaml";
...
export async function buildBundledDocument(
  ...
  const bundled: AnyRecord = {
    ...
    ...(root["x-awcms-micro-soft-delete-pattern"] !== undefined
      ? {
          "x-awcms-micro-soft-delete-pattern":
            root["x-awcms-micro-soft-delete-pattern"]
        }
      : {}),
    components: {
