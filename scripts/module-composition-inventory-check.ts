 ...
 * `docs/awcms-micro/module-composition-inventory.json` (Issue #740, epic
...
if (import.meta.main) {
  ...
  if (problems.length > 0) {
    ...
    console.log(
      "modules:composition:inventory:check OK — docs/awcms-micro/module-composition-inventory.json matches a fresh regeneration."
    );
  }
}
