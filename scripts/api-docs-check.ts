/**
 * Read-only freshness gate for `docs/awcms-micro/api-reference.md` (Issue
...
if (import.meta.main) {
  ...
  if (problems.length > 0) {
    ...
    console.log(
      "api:docs:check OK — docs/awcms-micro/api-reference.md matches deterministic generation from the bundled contracts."
    );
  }
}
