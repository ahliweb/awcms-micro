 ...
 * because `awcms_micro_audit_events` retention/purge is an administrative
...
async function main() {
  // Issue #683 (epic #679): `awcms_micro_worker` role — see migration 045.
    ...
    const result = await runJob(
      {
        ...
        description:
          "Purges awcms_micro_audit_events rows past retention for every active tenant.",
        handler: async (ctx) => {
