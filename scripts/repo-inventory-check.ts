/**
 * Read-only freshness gate for `docs/awcms-micro/repo-inventory.md` (Issue
...
if (import.meta.main) {
  ...
  if (problems.length > 0) {
    ...
    console.log(
      "repo:inventory:check OK — docs/awcms-micro/repo-inventory.md matches a fresh regeneration."
    );
  }
}
