...
AWCMS-Micro is the Bun + Astro 7 + PostgreSQL baseline for AhliWeb application development. Security reports should be handled privately and must not include production secrets, customer data, database dumps, access tokens, or screenshots that expose restricted information.
...
(`docs/awcms-micro/06_github_issues_detail.md`, 18 issues) is complete, so
...
<https://github.com/ahliweb/awcms-micro/security/advisories/new>
