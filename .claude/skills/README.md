...
| `awcms-micro-deploy`                                     | Pilih & jalankan profil deployment full-online (single-host compose vs image registry/Coolify, ADR-0027) + edge cache Varnish opsional | 18, deploy-coolify.md, edge-cache-varnish.md |
...
| `awcms-micro-comments`                                   | Kerjakan bagian mana pun modul `comments` — moderation-first, anti-abuse, privasi penulis (Issue #271, ADR-0032)                       | comments/SKILL.md, comments.md               |
| `awcms-micro-newsletter`                                 | Kerjakan bagian mana pun modul `newsletter` — consent-first, anti-enumeration, kampanye/digest (Issue #272, ADR-0033)                  | newsletter/SKILL.md, newsletter.md           |
...
| `awcms-micro-performance`        | Tuning performa aplikasi & database (query, index, pagination, pool) + edge cache opsional | 16, 07, edge-cache-varnish.md |
