---
name: awcms-micro-repo-inventory
description: Regenerate docs/awcms-micro/repo-inventory.md (module/migration/table-RLS/test/route inventory) setelah menambah modul, migration, tabel, test, atau route. Gunakan sebelum commit perubahan itu, atau saat `bun run repo:inventory:check` gagal di CI. Sesuai Issue #688 (epic #679 platform-hardening).
---

# AWCMS-Micro — Repo Inventory Regenerate

`docs/awcms-micro/repo-inventory.md` adalah dokumen **GENERATED** — jangan
...
itu tetap tanggung jawab skill `awcms-micro-github-snapshot` (live network
...
ENABLE ROW LEVEL SECURITY` di migration manapun. Tambahkan migration
   RLS (skill `awcms-micro-new-migration`), lalu regenerasi.
