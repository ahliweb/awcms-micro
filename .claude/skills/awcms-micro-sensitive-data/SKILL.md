...
2. Response umum hanya tampilkan `masked_value`; nilai penuh hanya untuk role berwenang lewat `awcms-micro-abac-guard`.
...
- Konsisten dengan redaction logger & `awcms-micro-audit-log`.
