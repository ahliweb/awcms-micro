---
name: awcms-micro-abac-guard
description: Terapkan kontrol akses RBAC+ABAC default-deny plus RLS pada endpoint/service AWCMS-Micro. Gunakan pada setiap endpoint non-public dan setiap akses data tenant-scoped. Menegakkan default deny, deny-overrides-allow, decision log, dan tenant isolation sesuai doc 03 & 10.
---

# AWCMS-Micro — ABAC Guard & Tenant Isolation

Ikuti `docs/awcms-micro/03_srs_detail_per_modul.md`, `docs/awcms-micro/10_template_kode_coding_standard.md`, dan **`docs/awcms-micro/17_default_seed_rbac_abac.md`** (matriks role→permission & default ABAC policy). Mekanisme RLS/tenant context konkret: `docs/awcms-micro/16_backend_data_access_integration.md`.
