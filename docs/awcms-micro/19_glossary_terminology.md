...
| **Derived Application**                    | Lapisan di luar repo base untuk modul domain spesifik vertikal (POS, portal sekolah, dst.) yang bukan SaaS Control Plane maupun ERP Extension — lihat `derived-application-guide.md` (jalur turunan DIHAPUS oleh ADR-0036; kini dipakai langsung sebagai template). |
