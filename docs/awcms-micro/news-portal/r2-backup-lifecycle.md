...
- **RTO (Recovery Time Objective)**: pembacaan gambar publik yang sudah
  ter-upload **tidak bergantung** pada ketersediaan aplikasi AWCMS-Micro
...
- `docs/awcms-micro/visitor-analytics.md` §Retensi — pola retensi bertingkat yang direplikasi di sini.
- `docs/awcms-micro/deployment-profiles.md` §Shared worker runner — `news-media:reconcile` sebagai salah satu job terdaftar.
