...
RLS-exempt, sama seperti `awcms_micro_permissions`/`awcms_micro_modules`/
`awcms_micro_idn_admin_regions` — lihat §Peta 23 modul di atas dan
...
- `docs/adr/0020-erp-extension-readiness-contracts.md`,
  `docs/awcms-micro/erp-extension-contracts.md` — kontrak kesiapan
