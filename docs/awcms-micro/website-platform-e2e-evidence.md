...
| Accessibility meets WCAG 2.2 target for critical journeys                                                                                     | [`admin-a11y-smoke.e2e.ts`](../../tests/e2e/admin-a11y-smoke.e2e.ts) + [`public-a11y-smoke.e2e.ts`](../../tests/e2e/public-a11y-smoke.e2e.ts) (axe-core, public EN/ID) + [`public-link-integrity.integration.test.ts`](../../tests/integration/public-link-integrity.integration.test.ts) (link check); **pilot-site full journey + device/SR matrix** | covered (new + existing); pilot → [§Deferred](#deferred-work) |
...
- **Full-journey accessibility & link checking** (**#296**) — the base-app
  ...
  STILL DEFERRED to the pilot: axe across the rendered derived-site full journey
  and the full desktop/mobile keyboard/screen-reader matrix.
