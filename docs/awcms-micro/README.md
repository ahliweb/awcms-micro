...
|  21 | `21_module_admission_governance.md`                   | Kategori modul (Core/System/Official Optional/Derived/Integration), pohon keputusan admission, dan pemetaan 17 modul terdaftar (Issue #696, WEBSITE scope ADR-0025)                                                                              |
