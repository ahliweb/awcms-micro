...
|   – | `work-continuation-log.md`                            | "Resume point" status kerja in-flight lintas-sesi (durable & ter-git, alternatif konteks worktree) — baca dulu saat melanjutkan pekerjaan; entri terkini = sinkronisasi docs/skills + audit konflik lintas-dokumen (2026-07-25)                  |
