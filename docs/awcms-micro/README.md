...
|   – | `website-platform-completion-runbook.md`              | Prosedur operator menuntaskan #292–#296 (deploy/DR/perf-CWV/a11y/pilot in-place) pada target live + bukti yang harus ditangkap; anchor penutup #273/#261 (ADR-0034)                                                                              |
...
|   – | `work-continuation-log.md`                            | "Resume point" status kerja in-flight lintas-sesi (durable & ter-git, alternatif konteks worktree) — baca dulu saat melanjutkan pekerjaan; entri terkini = sinkronisasi docs/skills pasca ADR-0036                                               |
