...
Dokumen ini berisi prompt untuk coding agent/developer agar implementasi AWCMS-Micro berjalan konsisten, aman, atomic, dan audit-ready.
...
| ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| Prompt Induk / Per Issue      | `awcms-micro-implement-issue`                                                                                                                 |
| Prompt Skeleton / Sprint 1–12 | `awcms-micro-implement-issue` + `awcms-micro-new-module` / `awcms-micro-new-migration` / `awcms-micro-new-endpoint` / `awcms-micro-new-event` |
| Idempotent posting (Sprint 5) | `awcms-micro-idempotency`                                                                                                                     |
| RBAC/ABAC (Sprint 3)          | `awcms-micro-abac-guard`                                                                                                                      |
| Sync HMAC (Sprint 8)          | `awcms-micro-sync-hmac`                                                                                                                       |
| Logging/masking (Sprint 6)    | `awcms-micro-audit-log` + `awcms-micro-sensitive-data`                                                                                        |
| Prompt Review PR              | `awcms-micro-pr-review`                                                                                                                       |
| Prompt Security Review        | `awcms-micro-security-review`                                                                                                                 |
| Prompt Production Preflight   | `awcms-micro-production-preflight`                                                                                                            |
...
| ------------------------ | ------------------------------ | -------------------------- |
| Prompt Induk / Per Issue | `awcms-micro-coder`            | Implementasi penuh         |
| Prompt Review PR         | `awcms-micro-reviewer`         | Read-only                  |
| Prompt Security Review   | `awcms-micro-security-auditor` | Read-only, verdict go-live |

Alur otomasi: issue → `awcms-micro-coder` → `awcms-micro-reviewer` → (modul sensitif) `awcms-micro-security-auditor` → merge.
...
```text
Anda adalah AWCMS-Micro Engineering Agent untuk proyek AWCMS-Micro Modular Monolith Standard.
...
```text
Objective:
Buat skeleton repository AWCMS-Micro berbasis Bun + Astro 7 + PostgreSQL dengan arsitektur modular monolith.
...
```text
Objective:
Implementasikan Sprint 1 AWCMS-Micro: repository foundation, migration runner, OpenAPI/AsyncAPI baseline, Docker Compose PostgreSQL, dan health endpoint.
...
Context:
AWCMS-Micro menggunakan Bun + Astro 7 + PostgreSQL, modular monolith, offline-first, RBAC+ABAC+RLS, audit log, OpenAPI, AsyncAPI.
...
```text
Kerjakan Issue 0.1 — Initialize AWCMS-Micro Modular Monolith Repository Structure.
