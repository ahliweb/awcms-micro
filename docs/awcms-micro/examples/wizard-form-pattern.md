...
Dokumen ini menjelaskan pola **multi-step wizard form** untuk AWCMS-Micro
...
Issue pelacak:
[#479 — UX: Add reusable multi-step wizard form pattern](https://github.com/ahliweb/awcms-micro/issues/479).
...
4. Memakai pola UI, i18n, aksesibilitas, dan keamanan AWCMS-Micro.
...
Pola ini wajib mengikuti guardrail AWCMS-Micro:
