...
`docs/awcms-micro/21_module_admission_governance.md` (kategori, pohon
...
yang relevan (lihat `docs/awcms-micro/derived-application-guide.md`).
...
`docs/awcms-micro/templates/module-admission-decision-checklist.md` sebagai
