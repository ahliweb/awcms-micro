# Dokumentasi GitHub AWCMS-Micro
...
Cara yang direkomendasikan (Issue #464, skill `awcms-micro-github-snapshot`):
...
```bash
gh issue list --repo ahliweb/awcms-micro --state all --limit 1000 --json number,title,state,createdAt,updatedAt,closedAt,author,labels,assignees,milestone,url,body,comments
gh label list --repo ahliweb/awcms-micro --limit 500 --json name,description,color
gh api 'repos/ahliweb/awcms-micro/milestones?state=all&per_page=100'
```

Update juga metadata di `docs/awcms-micro/README.md`, `06_github_issues_detail.md`, `09_roadmap_repository_commit.md`, `13_final_master_index_traceability.md`, dan `CHANGELOG.md` bila struktur dokumentasi berubah (di luar cakupan script).
...
- **[#587](https://github.com/ahliweb/awcms-micro/issues/587)** — `completed` — gate bersama `AUTH_ONLINE_SECURITY_ENABLED`/`_PROFILE` (`src/lib/auth/online-security-config.ts`), dua env var opsional yang WAJIB dicek setiap fitur #588-#592 sebelum melakukan apa pun online/provider-terkait. PR [#594](https://github.com/ahliweb/awcms-micro/pull/594) — auto-closed via `Closes #587` di badan PR (bukan tertinggal `open` seperti epic sebelumnya).
...
- **[#556](https://github.com/ahliweb/awcms-micro/issues/556)** — config online public tenant routing mode (`PUBLIC_TENANT_RESOLUTION_MODE` dkk.), fallback offline/LAN dipertahankan. PR [#568](https://github.com/ahliweb/awcms-micro/pull/568).
- **[#557](https://github.com/ahliweb/awcms-micro/issues/557)** — schema `awcms_micro_tenant_domains` (migration 031), RLS, unique index primary-dedup. PR [#569](https://github.com/ahliweb/awcms-micro/pull/569).
- **[#558](https://github.com/ahliweb/awcms-micro/issues/558)** — descriptor module `tenant_domain` terdaftar di `listModules()`. PR [#570](https://github.com/ahliweb/awcms-micro/pull/570).
- **[#559](https://github.com/ahliweb/awcms-micro/issues/559)** — `resolvePublicTenantFromRequest` (host/domain -> env/setup default -> 404 generic), migration 033 timing-parity. PR [#571](https://github.com/ahliweb/awcms-micro/pull/571).
- **[#560](https://github.com/ahliweb/awcms-micro/issues/560)** — rute publik `/news` (index/slug/category/tag/search/feed/sitemap), reuse resolver #559. PR [#572](https://github.com/ahliweb/awcms-micro/pull/572).
- **[#561](https://github.com/ahliweb/awcms-micro/issues/561)** — `/blog/{tenantCode}` didokumentasikan legacy (ADR-0010), tidak dihapus. PR [#573](https://github.com/ahliweb/awcms-micro/pull/573).
- **[#562](https://github.com/ahliweb/awcms-micro/issues/562)** — API manajemen tenant domain (CRUD, verify, set-primary), idempotency + audit. PR [#574](https://github.com/ahliweb/awcms-micro/pull/574).
- **[#563](https://github.com/ahliweb/awcms-micro/issues/563)** — admin UI domain/subdomain management. PR [#575](https://github.com/ahliweb/awcms-micro/pull/575).
- **[#564](https://github.com/ahliweb/awcms-micro/issues/564)** — tenant settings untuk `/news` route dan legacy route behavior (`publicRouteMode`). PR [#577](https://github.com/ahliweb/awcms-micro/pull/577).
- **[#565](https://github.com/ahliweb/awcms-micro/issues/565)** — tenant module presets (`online_website`/`news_portal`/`saas_online`/`pos_lan`/`minimal`), service layer. PR [#578](https://github.com/ahliweb/awcms-micro/pull/578).
- **[#566](https://github.com/ahliweb/awcms-micro/issues/566)** — layar admin tenant-module matrix, single-tenant scope. PR [#579](https://github.com/ahliweb/awcms-micro/pull/579).
- **[#567](https://github.com/ahliweb/awcms-micro/issues/567)** — adapter Cloudflare DNS opsional, provider boundary saja (belum di-wire ke rute). PR [#580](https://github.com/ahliweb/awcms-micro/pull/580).
...
(PR [#581](https://github.com/ahliweb/awcms-micro/pull/581)), value-shape
heuristic untuk module settings
(PR [#582](https://github.com/ahliweb/awcms-micro/pull/582)), single-module
lookup untuk gate publik `/news`
(PR [#583](https://github.com/ahliweb/awcms-micro/pull/583)), dan timeout
adapter Cloudflare yang env-tunable
(PR [#584](https://github.com/ahliweb/awcms-micro/pull/584)).
...
- **[#537](https://github.com/ahliweb/awcms-micro/issues/537)** — scaffold module, schema, dan permission seed (migration 026/027). PR [#545](https://github.com/ahliweb/awcms-micro/pull/545).
- **[#538](https://github.com/ahliweb/awcms-micro/issues/538)** — admin API + lifecycle actions untuk blog post (`/api/v1/blog/posts`). PR [#546](https://github.com/ahliweb/awcms-micro/pull/546).
- **[#539](https://github.com/ahliweb/awcms-micro/issues/539)** — pages, taksonomi, relasi post-term, dan PostgreSQL full-text search. PR [#547](https://github.com/ahliweb/awcms-micro/pull/547).
- **[#540](https://github.com/ahliweb/awcms-micro/issues/540)** — rute publik anonim (`/blog/{tenantCode}/...`), RSS, sitemap, SEO. PR [#548](https://github.com/ahliweb/awcms-micro/pull/548).
- **[#541](https://github.com/ahliweb/awcms-micro/issues/541)** — revision history append-only, scheduled publishing (`bun run blog:publish:scheduled`), dan kontrak AsyncAPI penuh. PR [#549](https://github.com/ahliweb/awcms-micro/pull/549).
- **[#542](https://github.com/ahliweb/awcms-micro/issues/542)** — template, menu hierarkis, widget, iklan, tema per-tenant, multilingual (`translation_group_id`), block `gallery`. PR [#550](https://github.com/ahliweb/awcms-micro/pull/550).
- **[#543](https://github.com/ahliweb/awcms-micro/issues/543)** — admin UI (14 layar `/admin/blog/...`), blog settings API (`/api/v1/blog/settings`), dan hardening akhir. PR [#551](https://github.com/ahliweb/awcms-micro/pull/551).
...
dan skill `awcms-micro-blog-content`. #537-#540 sempat tertinggal `open` di
...
database-backed, tenant-aware — `awcms_micro_modules` (migration 001) ada
sejak migration pertama tapi tidak pernah ditulis aplikasi mana pun
sampai epic ini. Dua belas issue, seluruhnya `completed`:

- **[#511](https://github.com/ahliweb/awcms-micro/issues/511)** — perluasan module descriptor contract (`permissions`/`navigation`/`settings`/`jobs`/`health` fields). PR [#523](https://github.com/ahliweb/awcms-micro/pull/523).
- **[#512](https://github.com/ahliweb/awcms-micro/issues/512)** — schema (`awcms_micro_modules` sudah ada; tabel baru untuk tenant-module lifecycle) + permission seed. PR [#524](https://github.com/ahliweb/awcms-micro/pull/524).
- **[#513](https://github.com/ahliweb/awcms-micro/issues/513)** — scaffold modul `module_management` + `descriptor-sync.ts` (`syncModuleDescriptors`, plan `create`/`update`/`unchanged` lalu upsert). PR [#525](https://github.com/ahliweb/awcms-micro/pull/525).
- **[#514](https://github.com/ahliweb/awcms-micro/issues/514)** — module catalog API (list/detail modul terdaftar). PR [#526](https://github.com/ahliweb/awcms-micro/pull/526).
- **[#515](https://github.com/ahliweb/awcms-micro/issues/515)** — tenant module lifecycle (enable/disable per tenant) dengan validasi dependency. PR [#527](https://github.com/ahliweb/awcms-micro/pull/527).
- **[#516](https://github.com/ahliweb/awcms-micro/issues/516)** — tenant-aware module settings management. PR [#528](https://github.com/ahliweb/awcms-micro/pull/528).
- **[#517](https://github.com/ahliweb/awcms-micro/issues/517)** — permission sync + status inspection (deteksi permission modul yang drift dari descriptor). PR [#529](https://github.com/ahliweb/awcms-micro/pull/529).
- **[#518](https://github.com/ahliweb/awcms-micro/issues/518)** — navigation registry + integrasi admin layout (sidebar dinamis per modul aktif). PR [#530](https://github.com/ahliweb/awcms-micro/pull/530).
- **[#519](https://github.com/ahliweb/awcms-micro/issues/519)** — job registry untuk operational command per modul. PR [#531](https://github.com/ahliweb/awcms-micro/pull/531).
- **[#520](https://github.com/ahliweb/awcms-micro/issues/520)** — module health/readiness checks. PR [#532](https://github.com/ahliweb/awcms-micro/pull/532).
- **[#521](https://github.com/ahliweb/awcms-micro/issues/521)** — admin UI Module Management (referensi pola SSR-read + fetch-ke-endpoint-terguard yang dipakai ulang oleh admin UI blog_content #543). PR [#533](https://github.com/ahliweb/awcms-micro/pull/533).
- **[#522](https://github.com/ahliweb/awcms-micro/issues/522)** — sinkronisasi contracts/SOP/threat model dokumentasi akhir. PR [#534](https://github.com/ahliweb/awcms-micro/pull/534).

Didokumentasikan penuh di `src/modules/module-management/README.md` dan
skill `awcms-micro-module-management`.
...
- **[#493](https://github.com/ahliweb/awcms-micro/issues/493)** — arsitektur modul provider-neutral + batas konfigurasi Mailketing. PR [#501](https://github.com/ahliweb/awcms-micro/pull/501).
- **[#494](https://github.com/ahliweb/awcms-micro/issues/494)** — schema tenant-safe, RLS FORCE, delivery queue migration (`sql/020`/`021`). PR [#502](https://github.com/ahliweb/awcms-micro/pull/502).
- **[#495](https://github.com/ahliweb/awcms-micro/issues/495)** — adapter Mailketing nyata + dispatcher outbox Bun. PR [#503](https://github.com/ahliweb/awcms-micro/pull/503).
- **[#496](https://github.com/ahliweb/awcms-micro/issues/496)** — flow forgot/reset password (`POST /api/v1/auth/password/forgot`/`reset`) — caller pertama yang benar-benar meng-enqueue baris `email_messages`. PR [#505](https://github.com/ahliweb/awcms-micro/pull/505).
- **[#497](https://github.com/ahliweb/awcms-micro/issues/497)** — bulk announcement/notification workflow (`POST /api/v1/email/announcements[/preview]`). PR [#506](https://github.com/ahliweb/awcms-micro/pull/506).
- **[#498](https://github.com/ahliweb/awcms-micro/issues/498)** — template management (CRUD, i18n rendering, safe variable allowlisting). PR [#504](https://github.com/ahliweb/awcms-micro/pull/504).
- **[#499](https://github.com/ahliweb/awcms-micro/issues/499)** — observability, security test, production readiness gate. PR [#507](https://github.com/ahliweb/awcms-micro/pull/507).
- **[#500](https://github.com/ahliweb/awcms-micro/issues/500)** — sinkronisasi OpenAPI/AsyncAPI/ERD/SOP/threat model/changeset akhir. PR [#508](https://github.com/ahliweb/awcms-micro/pull/508).
...
- **[#479](https://github.com/ahliweb/awcms-micro/issues/479)** — reusable multi-step wizard form pattern. PR [#480](https://github.com/ahliweb/awcms-micro/pull/480).
- **[#481](https://github.com/ahliweb/awcms-micro/issues/481)** — changeset untuk pola wizard form. PR [#486](https://github.com/ahliweb/awcms-micro/pull/486).
- **[#482](https://github.com/ahliweb/awcms-micro/issues/482)** — contoh pemakaian di modul domain turunan (`docs/awcms-micro/examples/wizard-form-pattern.md`). PR [#487](https://github.com/ahliweb/awcms-micro/pull/487).
- **[#483](https://github.com/ahliweb/awcms-micro/issues/483)** — fixture admin wizard minimal (bukti nyata pola bisa dipakai di admin shell). PR [#488](https://github.com/ahliweb/awcms-micro/pull/488).
- **[#484](https://github.com/ahliweb/awcms-micro/issues/484)** — server-side form draft persistence (`awcms_micro_form_drafts`, `sql/019`) — di-unblock setelah #482/#483 landed sebagai bukti kebutuhan konkret. PR [#491](https://github.com/ahliweb/awcms-micro/pull/491).
- **[#485](https://github.com/ahliweb/awcms-micro/issues/485)** — accessibility coverage untuk komponen wizard reusable. PR [#489](https://github.com/ahliweb/awcms-micro/pull/489).

Didokumentasikan penuh di `docs/awcms-micro/examples/wizard-form-pattern.md`,
`src/modules/form-drafts/README.md`, dan skill `awcms-micro-wizard-form`/
`awcms-micro-form-drafts`.
...
- **[#461](https://github.com/ahliweb/awcms-micro/issues/461)** — refresh manual snapshot `docs/awcms-micro/github/` (issue, label, milestone, security) setelah #450-#454 closed.
- **[#464](https://github.com/ahliweb/awcms-micro/issues/464)** — `scripts/github-snapshot-refresh.ts` (`bun run github:snapshot:refresh`): regenerasi mekanis tabel metadata + dua tabel daftar issue via marker, tanpa menyentuh narasi hand-written.
- **[#462](https://github.com/ahliweb/awcms-micro/issues/462)** — `docs/awcms-micro/deploy-coolify.md`: panduan deploy Coolify (single-VPS, multi-aplikasi, opsi PostgreSQL, checklist keamanan).
- **[#463](https://github.com/ahliweb/awcms-micro/issues/463)** — `docs/awcms-micro/examples/minimal-domain-module.md`: contoh konkret satu modul domain minimal (`asset-register`), tiap snippet diverifikasi terhadap modul aktif nyata.
- **[#465](https://github.com/ahliweb/awcms-micro/issues/465)** — `docs/awcms-micro/derived-app-pilot-plan.md`: rekomendasi AWPOS sebagai pilot aplikasi turunan pertama, berdasarkan inspeksi nyata repo `ahliweb/awpos` (18 dari 38 issue-nya sudah tercakup base ini).
- **[#473](https://github.com/ahliweb/awcms-micro/issues/473)** — perbaikan `issueTableRow()` di `github-snapshot-refresh.ts` agar URL issue generated memakai repo dinamis, bukan hardcode `ahliweb/awcms-micro`.
- **[#475](https://github.com/ahliweb/awcms-micro/issues/475)** — perbaikan `github-snapshot-refresh.ts` agar CodeQL run yang masih `in_progress` tidak salah dilaporkan sebagai `Failure` — ditemukan live saat menjalankan refresh untuk #472 (baris "Latest CodeQL run" kini dilewati, bukan ditebak, bila run belum `completed`).

Dua skill baru ditambahkan mengikuti kapabilitas di atas: `awcms-micro-deploy` dan `awcms-micro-github-snapshot` (lihat `.claude/skills/README.md`).
...
- **[#450](https://github.com/ahliweb/awcms-micro/issues/450)** — sinkronisasi `AGENTS.md`/`docs/awcms-micro/README.md`/`docs/ARCHITECTURE.md`/`src/lib/README.md` agar tidak lagi terbaca seolah base masih di tengah foundation ("Kerjakan Issue 0.1", "modul belum diimplementasikan"); arsip bootstrap di doc 12/13 diberi banner status, bukan dihapus.
- **[#451](https://github.com/ahliweb/awcms-micro/issues/451)** — ADR-0008: tiga skema SemVer independen (rilis package, kontrak OpenAPI/AsyncAPI, module descriptor). Kontrak dinaikkan `0.1.0` → `1.0.0`; ketujuh module descriptor `experimental` → `active`. `api:spec:check` kini memvalidasi `info.version` berbentuk SemVer.
- **[#452](https://github.com/ahliweb/awcms-micro/issues/452)** — CodeQL matrix diperluas dari `actions` saja menjadi `actions` + `javascript-typescript` (`build-mode: none`, Bun-only). Dua temuan nyata dari scan pertama (`js/unused-local-variable`, `js/file-system-race`) diperbaiki dan dikonfirmasi `state: fixed` — lihat `security.md`.
- **[#453](https://github.com/ahliweb/awcms-micro/issues/453)** — `docs/awcms-micro/derived-application-guide.md` baru: tabel base-reusable vs domain-specific, alur 9 langkah berbasis skill nyata, 5 contoh aplikasi turunan ilustratif, checklist keamanan.
- **[#454](https://github.com/ahliweb/awcms-micro/issues/454)** — `Dockerfile.production` opsional (registry-based deployment, berdampingan dengan `docker-compose.yml` LAN-first) — diverifikasi nyata: `docker build` + `docker run` terhadap Postgres nyata, non-root user dikonfirmasi, `GET /api/v1/health` → 200, `POST /setup/initialize` menulis baris nyata.

### Epic M9 — Peningkatan & Hardening pasca-backlog tuntas (2026-07-06)

Milestone M9 (5 anak issue peningkatan pasca-backlog v0.22.0, epic [#438](https://github.com/ahliweb/awcms-micro/issues/438)) dan satu issue lanjutan berdiri sendiri di milestone yang sama, seluruhnya `completed`:

- **[#433](https://github.com/ahliweb/awcms-micro/issues/433)** — runtime i18n (katalog `.po` gettext, default `en`, min en+id).
- **[#434](https://github.com/ahliweb/awcms-micro/issues/434)** — audit UX/UI & aksesibilitas WCAG 2.1 AA atas layar admin yang sudah ada.
- **[#435](https://github.com/ahliweb/awcms-micro/issues/435)** — audit performa (index RLS-aware, N+1 dihilangkan, keyset pagination — diukur `EXPLAIN ANALYZE` sebelum/sesudah).
- **[#436](https://github.com/ahliweb/awcms-micro/issues/436)** — dispatcher object sync queue nyata + kerasan integrasi eksternal (circuit breaker per-provider, timeout).
- **[#437](https://github.com/ahliweb/awcms-micro/issues/437)** — security hardening berbasis standar (matrix kepatuhan OWASP Top 10/ASVS/ISO 27001).
- **[#438](https://github.com/ahliweb/awcms-micro/issues/438)** — epic tracking, ditutup setelah 5/5 anak issue selesai.
- **[#447](https://github.com/ahliweb/awcms-micro/issues/447)** — aktivasi sistem log & manajemennya (correlation ID otomatis lintas endpoint, retensi/purge audit log terjadwal, extension point observability) — issue berdiri sendiri, bukan bagian 5 anak epic #438.

Detail lengkap tiap issue: `CHANGELOG.md` (versi 0.23.0-0.23.5) dan `docs/awcms-micro/AUDIT_STANDAR_PENGEMBANGAN_2026-07-04.md` §Perawatan pasca-backlog.
...
Backlog `docs/awcms-micro/06_github_issues_detail.md` §Dokumen acuan per epic juga diselaraskan untuk merujuk ADR + doc 20 per epic. (Reconciliation #1 ini ternyata tidak lengkap — 12 issue lain baru menyusul di Reconciliation #2 di atas.)

### Genericization (2026-07-04)

Repository awcms-micro adalah **contoh repo pengembangan umum** (base modular monolith reusable), bukan aplikasi domain. Backlog awal (38 issue, aktivasi pertama pada hari yang sama) ternyata memuat epic domain POS/retail yang salah tempat. Perbaikan yang dilakukan:
...
- **Docs diperbaiki** agar konsisten dengan base generik: `docs/awcms-micro/06_github_issues_detail.md` ditulis ulang (backlog 18 issue), `docs/awcms-micro/01_canvas_induk.md` ditulis ulang (hapus modul/fase domain), `AGENTS.md` §Peta modul dan `docs/awcms-micro/09_roadmap_repository_commit.md` §Struktur source diperbaiki (hapus daftar modul domain).
...
- `docs/awcms-micro/06_github_issues_detail.md` adalah rencana/template issue atomic generik; sebagian issue sudah selesai dan sisanya tercatat di snapshot open.
- `docs/awcms-micro/github/` adalah snapshot state GitHub aktual.
- `docs/awcms-micro/github/security.md` mencatat setup GitHub Security dan alert count saat refresh.
- `docs/awcms-micro/09_roadmap_repository_commit.md` mengatur urutan branch, commit, PR, release, dan changeset.
