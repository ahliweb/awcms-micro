...
| Kandidat                              | Kebutuhan bisnis | Risiko keamanan/privacy (lebih rendah lebih baik)                    | Kompleksitas data                   | Nilai validasi platform | Kesiapan implementasi                                  | Relevansi AhliWeb/AWCMS-Micro               |
| ------------------------------------- | ---------------- | -------------------------------------------------------------------- | ----------------------------------- | ----------------------- | ------------------------------------------------------ | ------------------------------------------- |
...
- Repo GitHub nyata: [`ahliweb/awpos`](https://github.com/ahliweb/awpos),
  ...
  `docs/awcms-micro/01`-`19` di repo ini.
...
Ini bukan kebetulan — `docs/awcms-micro/AUDIT_STANDAR_PENGEMBANGAN_2026-07-04.md`
mencatat bahwa AWCMS-Micro direfaktor total pada 2026-07-04 mengikuti paket
...
ulang di AWPOS, tetapi dengan menjadikan AWCMS-Micro sebagai base/dependency
AWPOS. Pemetaan langsung (nomor issue AWPOS, judul identik dengan issue
yang sudah `completed` di base ini):

| Issue AWPOS (\#, judul)                  | Status di base AWCMS-Micro                                                                                                    |
| ---------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
...
adalah 20 issue domain-specific di atas, dikerjakan di atas AWCMS-Micro
...
| Tetap di base (AWCMS-Micro — jangan diubah)                                           | Modul domain baru AWPOS (repo turunan)                                               |
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
...
1. **Tutup 18 issue yang sudah tercakup base** (#1-#3, #6-#9, #21-#23,
   ...
   ke AWPOS.
2. **Tambahkan AWCMS-Micro sebagai base/dependency** AWPOS (fork, git
