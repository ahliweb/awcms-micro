...
The wrapper is the required automatic update path for these changes because it consumes pending root changesets, updates `VERSION`, prepends `CHANGELOG.md`, and refreshes the workspace snapshot in one step.
