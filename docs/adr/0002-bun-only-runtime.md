...
- **Status:** Accepted
- **Tanggal:** 2026-07-05
- **Terkait:** `AGENTS.md` (aturan 14), `docs/awcms-micro/10_template_kode_coding_standard.md` (§Standar platform backend), `docs/awcms-micro/18_configuration_env_reference.md` (§Runtime & tooling)
