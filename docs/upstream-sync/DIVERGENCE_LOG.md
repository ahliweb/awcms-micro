...
| 2026-05-24 | `awcmsmicro-dev/.github/workflows/*` | adapt | Rewrote privileged workflow automation into manual/read-only workflows | Remove GitHub App token usage and untrusted privileged checkouts while preserving manual maintenance paths | Workflow maintenance surface only | OpenCode / GPT-5.4 |
