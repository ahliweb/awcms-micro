...
- Dependabot open alerts remain at 65 in `emdash-latest/` and 46 in `awcmsmicro-dev/`; the downstream marketplace, docs, perf-monitor, core, admin, docs-catalog, and blocks-playground overlays are recorded separately in `DIVERGENCE_LOG.md`.
