...
- Dependabot open alerts remain at 65 in `emdash-latest/` and 41 in `awcmsmicro-dev/`; the downstream marketplace, docs, perf-monitor, core, admin, docs-catalog, blocks-playground, and admin-dompurify overlays are recorded separately in `DIVERGENCE_LOG.md`.
