 ...
 * real Postgres connection running as the actual `awcms_micro_worker` role
...
suite("runAuditLogPurge (migrated to shared worker runner, Issue #697)", () => {
  ...
  test("runs successfully under the real awcms_micro_worker role (Issue #683, epic #679)", async () => {
