...
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------ |
| `base-version-range/`             | `compatibleAwcmsMicroRange` set to `">=99.0.0 <100.0.0"`, excluding this repo's real current version                                                | `base_version_range_incompatible`          |
...
and
[`docs/awcms-micro/derived-application-guide.md`](../../../docs/awcms-micro/derived-application-guide.md)
