 ...
 * `openapi/awcms-micro-public-api.src.yaml` + `openapi/modules/*.yaml` into
 * the published `openapi/awcms-micro-public-api.openapi.yaml`. Two
...
`;
  ...
  async function withFixture(
    ...
    try {
      ...
      await writeFile(
        path.join(rootDir, "openapi/awcms-micro-public-api.src.yaml"),
        rootFixture,
        "utf8"
      );
