 ...
 */
const VISITOR_KEY_COOKIE_NAME = "awcms_micro_visitor_key";
 ...
 * time (recorded in `.claude/skills/awcms-micro-visitor-analytics/SKILL.md`).
 */
...
export async function collectRequestAnalytics(
  ...
  try {
    ...
    // off — see `docs/awcms-micro/visitor-analytics.md` §Default opt-in
