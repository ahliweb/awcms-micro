 ...
 * (`awcms_micro_auth_providers`, migration 036), not deployment-wide env
 ...
 * id/secret are tenant-configured DATA (`awcms_micro_auth_providers`), whose
...
/**
 * Caps how many active (non-deleted) `awcms_micro_auth_providers` rows a
