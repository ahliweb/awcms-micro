 ...
 * cached JSON becomes a cache miss and never blocks the authoritative loader.
 */
...
/**
 * Generic cache-aside flow. The loader is always the source of truth; Redis is
 * only an acceleration layer and is never consulted inside a DB transaction.
 */
