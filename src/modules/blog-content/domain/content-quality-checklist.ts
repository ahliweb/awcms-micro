 ...
 * `.claude/skills/awcms-micro-news-portal/SKILL.md` §636 "Ketika mode TIDAK
 ...
 * `awcms_micro_blog_settings.settings.contentQualityChecklistPolicy`
 ...
 * taxonomy assignment table at all (`awcms_micro_blog_pages` has no
 * `_terms` junction, unlike posts' `awcms_micro_blog_post_terms`), so
