 ...
 *    (`module.ts`) + the tenant's `awcms_micro_module_settings` override,
 ...
 * 2. `awcms_micro_blog_settings` (Issue #537, wired up by Issue #543,
 ...
 *    `awcms_micro_blog_settings` value and stay enabled. `rssEnabled`/
