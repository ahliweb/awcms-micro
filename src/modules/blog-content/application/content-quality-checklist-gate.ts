...
export type ChecklistEvaluableContent = {
  ...
  /** Issue #649 — explicit "use this image for social/SEO preview" override. Optional/omittable — `awcms_micro_blog_pages` has no such column, so the "page" content kind's caller simply never provides it (treated as `null`, same as not having one). */
