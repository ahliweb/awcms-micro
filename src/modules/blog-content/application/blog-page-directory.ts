...
/**
 * Read/write query module for `awcms_micro_blog_pages` (Issue #539) — same
...
export async function createBlogPage(
  ...
  const rows = (await tx`
    INSERT INTO awcms_micro_blog_pages
