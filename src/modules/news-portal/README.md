...
> `.claude/skills/awcms-micro-news-portal/SKILL.md`'s tabel "Status per
...
`.claude/skills/awcms-micro-news-portal/SKILL.md` §632 untuk alasan
...
`docs/awcms-micro/news-portal/full-online-r2-architecture.md` §2/§4).
...
- `.claude/skills/awcms-micro-news-portal/SKILL.md` — status penuh epic +
  keputusan arsitektur.
- `docs/awcms-micro/news-portal/full-online-r2-architecture.md` —
  arsitektur R2-only lengkap.
- `docs/awcms-micro/18_configuration_env_reference.md` §News portal.
