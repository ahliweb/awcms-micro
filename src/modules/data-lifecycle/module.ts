  ...
  dataLifecycle: [
    {
      ...
      tableName: "awcms_micro_data_lifecycle_runs",
      ...
      batchLimit: 5000,
      backupRestoreNotes:
        "Included in ordinary full-database backup/restore (docs/awcms-micro/resilience-dr-verification.md); archived rows additionally have a standalone JSONL artifact restorable independently of a full database restore.",
