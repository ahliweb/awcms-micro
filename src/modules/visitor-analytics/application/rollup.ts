 ...
 * Aggregates `awcms_micro_visit_events` into `awcms_micro_visitor_daily_rollups`
...
/**
 * Idempotent UPSERT into `awcms_micro_visitor_daily_rollups`. `ON CONFLICT
 ...
 * for a first cut of this job; see `docs/awcms-micro/visitor-analytics.md`
