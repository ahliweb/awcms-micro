  ...
  dataLifecycle: [
    {
      ...
      tableName: "awcms_micro_visit_events",
      ...
      requiredIndexes: [
        {
          ...
          purpose:
            "awcms_micro_visit_events_tenant_occurred_idx (migration 039) — the same index purgeVisitorAnalyticsData's own age-based DELETE already relies on."
        }
      ],
      batchLimit: 5000,
      backupRestoreNotes:
        "Included in ordinary full-database backup/restore (docs/awcms-micro/resilience-dr-verification.md); no standalone archive artifact exists yet (archive.archivable is false above) — by design, given the privacy-first retention posture.",
