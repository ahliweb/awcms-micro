 ...
 * the per-tenant runtime PAUSE FLAG (`awcms_micro_domain_event_consumer_state`),
...
export async function listConsumerStates(
  ...
  const stateRows = (await tx`
    ...
    FROM awcms_micro_domain_event_consumer_state
...
export async function pauseConsumer(
  ...
  await tx`
    INSERT INTO awcms_micro_domain_event_consumer_state
