 ...
 * `awcms_micro_domain_event_consumer_effects` (Issue #742 security
 ...
 *
 * Why this is needed IN ADDITION to `awcms_micro_domain_event_deliveries`'s
...
export async function applyConsumerEffectOnce(
  ...
  const rows = (await tx`
    INSERT INTO awcms_micro_domain_event_consumer_effects
