 ...
 * `docs/awcms-micro/news-portal/full-online-r2-architecture.md` §2,
 * "Keputusan kunci #1" in `.claude/skills/awcms-micro-news-portal/SKILL.md`).
 *
...
/**
 * Keputusan kunci #1 (`.claude/skills/awcms-micro-news-portal/SKILL.md`,
