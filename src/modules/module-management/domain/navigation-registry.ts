...
export type NavigationFilterOptions = {
  ...
  /** Module keys the tenant has explicitly disabled (`awcms_micro_tenant_modules.enabled = false`). A module absent from this set is available by default — same convention as the tenant module lifecycle service. */
