 ...
 * `docs/awcms-micro/21_module_admission_governance.md` §7 for the binding
 ...
 * `sql/NNN_awcms_micro_*.sql` file this repo ever ships must stay within
 ...
 * reported as a possible gap in `docs/awcms-micro/repo-inventory.md` if
