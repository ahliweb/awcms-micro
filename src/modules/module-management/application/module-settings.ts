 ...
 * operational preferences only — `awcms_micro_module_settings.settings` must
...
export async function updateModuleSettings(
  ...
  // `awcms_micro_module_settings.module_key` has an FK to
  // `awcms_micro_modules` — same reasoning as
  ...
  await tx`
    INSERT INTO awcms_micro_module_settings
