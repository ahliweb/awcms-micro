 ...
 * composed by `theme-registry.ts` from the reviewed base themes; ADR-0036 removed
 * the derived-repo seam — themes live directly in this template); only a
