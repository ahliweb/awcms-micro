...
/** `GET /api/v1/blog/theme` (Issue #542) — this tenant's blog theme mode, falling back to `awcms_micro_tenants.default_theme` when no override row exists (`isOverride: false`). */
