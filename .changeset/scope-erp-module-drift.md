...
- **Rekonsiliasi dokumen ke registry WEBSITE 17 modul:** doc arsitektur (01/02/03/05/06/09/10/11), ERD/data dictionary (04), SOP operasional (08 — lima seksi SOP modul ERP dihapus), threat model (20), module admission governance (21), dan traceability (13) kini mendeskripsikan hanya 17 modul aktif (termasuk `media_library`). Matrix migration doc 13 diperbaiki ke 64 file nyata (001–079) yang dipetakan benar per modul; klaim "23 modul"/"76 migration" dihapus.
