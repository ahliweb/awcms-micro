...
-- `awcms_micro_tenant_domains` table (migration 031). Exactly the six
...
-- existing `INSERT INTO awcms_micro_permissions` migration). No
...
-- `sql/027_awcms_micro_blog_content_permissions.sql`.
