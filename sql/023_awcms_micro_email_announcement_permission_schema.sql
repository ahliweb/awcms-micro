...
-- tables (`awcms_micro_tenant_users`, `awcms_micro_access_assignments`,
-- `awcms_micro_identities`, `awcms_micro_profiles`, `awcms_micro_email_
-- suppression_list`) and writes existing `awcms_micro_email_messages`
