...
--
-- Adds a transient `sending` status to `awcms_micro_object_sync_queue` so the
...
ALTER TABLE awcms_micro_object_sync_queue
  DROP CONSTRAINT awcms_micro_object_sync_queue_status_check;

ALTER TABLE awcms_micro_object_sync_queue
  ADD CONSTRAINT awcms_micro_object_sync_queue_status_check
